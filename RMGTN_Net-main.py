...
from src.model.RMGTN_Net import *
...
class MyCLI(LightningCLI):
    ...
    def before_fit(self):
        ...
        if resume_from_checkpoint is not None:
            ...
            self.trainer.logger = TensorBoardLogger('logs/', name="mcnet_twosplit", default_hp_metric=False)
...
if __name__ == '__main__':
    cli = MyCLI(McNet, MyDataModule, seed_everything_default=True, save_config_kwargs={"overwrite": True}, save_config_callback=SaveConfigCallback)
