...
cleandir = "/home/doyourthing_zyk/data/finaldataset/test/noisy/"
noisydir = "/home/doyourthing_zyk/data/finaldataset/test/clean/"
...
for yr_hat,yr in tqdm(zip(noisylist,cleanlist)):
    ...
    yr_hat_t = torch.from_numpy(yr_hat_t)[:,5]
