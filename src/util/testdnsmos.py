...
def testdns(predictpath,csv_path='out_noisy.csv',per_mos=False):
    # 模拟命令行参数的手动赋值
    args = argparse.Namespace(
        testset_dir=predictpath,
        csv_path=csv_path,
        personalized_MOS=per_mos # 如果想要这个flag为True，直接设置为True；为False就设置为False
    )
    main(args)

testdns("/home/doyourthing_zyk/data/finaldataset/test/clean/")
